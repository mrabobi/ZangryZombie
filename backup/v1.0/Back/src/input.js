...
export default class InputHandler {
    ...
    document.addEventListener("keyup", event => {
      switch (event.keyCode) {
        case 37:
       {
        ...
        case 88:
         {
          if (   this.game.player.orientation === "r")    this.game.player.stopRight();
          else if (   this.game.player.orientation === "l")    this.game.player.stopLeft();
          this.x_key=false;
        }
          break;
  ...
  execute_commands()
  {
    ...
    if(this.x_key===true)
  if ( this.game.player.orientation == "r")     this.game.player.atackRight();
   else if ( this.game.player.orientation == "l")     this.game.player.atackLeft();
    if(this.z_key===true)
