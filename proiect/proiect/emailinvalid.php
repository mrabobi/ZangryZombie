...
<body background="bg.jpg">
        ...
        <h1 style="color:DarkOliveGreen ;font-size:4vw ; font-style:italic;"> Adresa de email sau parola este invalida! </h1>

        <a href="index1.php" class="start">Introduceti datele din nou</a>
